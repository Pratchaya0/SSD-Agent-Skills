---
name: ssd-database
description: ใช้ skill นี้เมื่อตั้งชื่อ database objects (table, column, stored procedure), กำหนด standard columns, หรือถามเรื่อง EF Core model และ migration ตามมาตรฐาน SSD
version: 1.0.0
---
