---
name: ssd-frontend-refactor
description: ใช้ skill นี้เมื่อต้องการแก้ไข code React/TypeScript (.tsx/.ts) ให้ตรงมาตรฐาน SSD อย่างปลอดภัย โดยไม่ทำให้ compile พัง — ใช้หลัง ssd-frontend-review หรือใช้เดี่ยวเมื่อรู้ violations อยู่แล้ว
version: 1.0.0
---
