---
name: ssd-frontend-review
description: ใช้ skill นี้เมื่อต้องการตรวจสอบ code React/TypeScript (.tsx/.ts) ว่าตรงมาตรฐาน SSD หรือไม่ — ครอบคลุม naming, component structure, TypeScript types, Formik, Redux, React Query, และ environment variables
version: 1.0.0
---
