---
name: ssd-git-commit
description: ใช้ skill นี้เมื่อเขียน git commit message, กำหนดเวอร์ชัน (semantic versioning), ใช้งาน release-it, หรือถามเรื่อง commit type/scope/breaking change ตามมาตรฐาน SSD
version: 1.0.0
---
