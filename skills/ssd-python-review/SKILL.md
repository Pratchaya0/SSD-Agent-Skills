---
name: ssd-python-review
description: ใช้ skill นี้เมื่อต้องการตรวจสอบ code Python (.py) ว่าตรงมาตรฐาน SSD หรือไม่ — ครอบคลุม Clean Architecture, HTTP methods, naming, structlog, error handling, SQLAlchemy, HTTPX client, และ APScheduler jobs
version: 1.0.0
---
