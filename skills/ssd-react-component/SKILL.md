---
name: ssd-react-component
description: ใช้ skill นี้เมื่อเขียน React component, กำหนด Props type, ใช้ Refs/Fragments, ตั้งชื่อ component, page, หรือ module ตามมาตรฐาน SSD
version: 1.0.0
---
