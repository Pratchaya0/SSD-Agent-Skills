---
name: ssd-git-flow
description: ใช้ skill นี้เมื่อทำงานกับ Git Flow workflow, ตั้งชื่อ branch, สร้าง pull request, แก้ไข merge conflict, ใช้ SourceTree, หรือถามเรื่องขั้นตอน git ของ SSD
version: 1.0.0
---
