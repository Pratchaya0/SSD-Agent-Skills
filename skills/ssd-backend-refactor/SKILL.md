---
name: ssd-backend-refactor
description: ใช้ skill นี้เมื่อต้องการแก้ไข code C#/.NET (.cs) ให้ตรงมาตรฐาน SSD อย่างปลอดภัย โดยไม่ทำให้ build พัง — ใช้หลัง ssd-backend-review หรือใช้เดี่ยวเมื่อรู้ violations อยู่แล้ว
version: 1.0.0
---
