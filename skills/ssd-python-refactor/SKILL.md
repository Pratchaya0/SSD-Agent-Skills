---
name: ssd-python-refactor
description: ใช้ skill นี้เมื่อต้องการแก้ไข code Python (.py) ให้ตรงมาตรฐาน SSD อย่างปลอดภัย โดยไม่ทำให้ pytest พัง — ใช้หลัง ssd-python-review หรือใช้เดี่ยวเมื่อรู้ violations อยู่แล้ว
version: 1.0.0
---
