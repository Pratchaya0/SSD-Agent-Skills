---
name: ssd-backend-review
description: ใช้ skill นี้เมื่อต้องการตรวจสอบ code C#/.NET (.cs) ว่าตรงมาตรฐาน SSD หรือไม่ — ครอบคลุม naming, controller, service, DTO, AutoMapper, logging, authorization และ modifier order
version: 1.0.0
---
